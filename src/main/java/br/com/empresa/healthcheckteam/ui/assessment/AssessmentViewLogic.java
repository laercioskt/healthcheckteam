 ...
 * data.
 */
public class AssessmentViewLogic implements Serializable {

    private final AssessmentRepository assessmentRepository;
    private final AssessmentView view;

    public AssessmentViewLogic(AssessmentRepository assessmentRepository, AssessmentView simpleCrudView) {
    ...
    private void setFragmentParameter(String assessmentId) {
        ...
        UI.getCurrent().navigate(AssessmentView.class, fragmentParameter);
    }
    ...
    public void enter(String assessmentId) {
        if (assessmentId != null && !assessmentId.isEmpty()) {
            if (assessmentId.equals("new")) {
                ...
                // login
                try {
                    final Long pid = Long.parseLong(assessmentId);
                    findAssessment(pid).ifPresent(view::selectRow);

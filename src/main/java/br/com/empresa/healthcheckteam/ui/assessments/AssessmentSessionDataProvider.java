 ...
 * <p>
 * Used to simplify the code in {@link AssessmentSessionView} and
 * {@link AssessmentSessionViewLogic}.
 */
public class AssessmentSessionDataProvider extends ListDataProvider<Assessment> {
    ...
    public AssessmentSessionDataProvider(AssessmentRepository assessmentRepository) {

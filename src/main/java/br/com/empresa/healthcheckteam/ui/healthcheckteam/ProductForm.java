...
import br.com.empresa.healthcheckteam.backend.data.Availability;
...
public class ProductForm extends Div {
    ...
    private final HealthCheckTeamViewLogic viewLogic;
    ...
    public ProductForm(HealthCheckTeamViewLogic sampleCrudLogic) {
